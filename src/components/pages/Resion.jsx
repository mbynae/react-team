...
const Resion = ({calendar, year, month, date, week}) => {
    ...
    useEffect(() => {
        ...
        fetch(`https://airbnb19.p.rapidapi.com/api/v1/searchPropertyByPlace?id=${id}&totalRecords=12&currency=KRW&category=TAB_8253&adults=1&checkin=${calendar}&checkout=${calendar+1}&languageId=ko-KR`, options)
